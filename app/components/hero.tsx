      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          <Button size="lg" className="bg-blue-600 text-white hover:bg-white hover:text-blue-600 transition-colors" variant="secondary" asChild>
            <a href="https://www.linkedin.com/in/ahmedhqadri/" target="_blank" rel="noopener noreferrer" className="flex items-center">
          ...
          <Button
            ...
            asChild
          >
            <a href="https://github.com/ahmedhqadri" target="_blank" rel="noopener noreferrer" className="flex items-center">
              Github Profile
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 ml-2" viewBox="0 0 24 24" fill="currentColor">
